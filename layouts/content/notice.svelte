<script>
    export let headerImage, header, title, tbody, publish, para1title, para1, para2title, para2, para3title, para3, download;
</script>
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex">
                    ...
                    <span class="h2 d-block">{publish.day}</span> {publish.date}
                    </div>
                    </div>
                    <div class="content">
