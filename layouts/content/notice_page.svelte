...
<section class="section">
    <div class="container">
        <div class="row">
            ...
            <div class="d-md-table-cell text-center p-4 bg-primary text-white mb-4 mb-md-0"><span class="h2 d-block">{notice.fields.publish.day}</span> {notice.fields.publish.date}</div>
            <div class="d-md-table-cell px-4 vertical-align-middle mb-4 mb-md-0">
            <a href="{notice.path}" class="h4 mb-3 d-block">{notice.fields.title}</a>
            <p class="mb-0">{notice.fields.tbody}</p>
            </div>
            <div class="d-md-table-cell text-right pr-0 pr-md-4"><a href="{notice.path}" class="btn btn-primary">{notice.fields.link.title}</a></div>
            </li>
            </ul>
            </div>
            {/each}
